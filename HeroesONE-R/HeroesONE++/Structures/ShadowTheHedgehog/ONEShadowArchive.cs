...
namespace HeroesONE_R.Structures.ShadowTheHedgehog
{
    ...
    public unsafe struct ONEShadowArchive 
    {
        ...
        public static ONEShadowArchive ParseONEFile(ref byte[] file)
        {
            ...
            oneShadowArchive.FileHeader = StructUtilities.MemoryOffsetToPointer<ONEHeader>(ref file, pointer, ref pointer);
            oneShadowArchive.OneVersion = StructUtilities.MemoryOffsetToPointer<ONEFileVersion>(ref file, pointer, ref pointer);
            oneShadowArchive.FileCount  = StructUtilities.MemoryOffsetToPointer<int>(ref file, pointer, ref pointer);
            oneShadowArchive.OnePadding = StructUtilities.MemoryOffsetToPointer<ONEPadding>(ref file, pointer, ref pointer);
            ...
            for (int x = 0; x < oneShadowArchive.FileCount + 2; x++)
            {
                ...
                {
                    ONE50FileEntry entry = StructUtilities.MemoryOffsetToPointer<ONE50FileEntry>(ref file, pointer, ref pointer);
                ...
                {
                    ONE60FileEntry entry = StructUtilities.MemoryOffsetToPointer<ONE60FileEntry>(ref file, pointer, ref pointer);
